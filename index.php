...
<body>
    <img src="logo.jpg" alt="logo image" style=" width:200px;height:300px;" class="logo">
    <h1 class="text1">  <span class=" text1"  >Web project </span></h1>
    <div class="container">
        <div class="tab">
        ...
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    <!--Package One-->
                    <h2 style=" ;">REGISTRATION FORM  PLEASE FILLS OUT CARFULLY</h2>
                    <hr>
                    <!--First Name-->
                    ...
                    <br>
                    <!--Package Two-->
                    <h2>ENTER YOURE EDUCTIONAL STATUS</h2>
                    <hr>
                    <!--EDUCATIONAL STATUS -->
