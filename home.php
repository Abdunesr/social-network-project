...
<body>
<img src="logo.jpg" alt="logo image" class="im";>
    <div class="container">
            ...
            <form method="post" action="" onsubmit="return validatePost()" enctype="multipart/form-data">
                ...
                <div class="createpostbuttons">
                    ...
                    <label>
                        ...
                        <input type="file" name="fileUpload" id="imagefile" value="<i class='bx bx-upload bx-tada' ></i>">
                        <!--<input type="submit" style="display:none;">-->
                    </label>
                    <input type="submit" value="Post" name="post" style=" background-color:grey;">
                    <!--</form>-->
                </div>
            </form>
        </div>
